...
<body id="page-top">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#why">Why SwaP?</a>
                    </li>
                    <li>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <hr>
                <h3 style="font-style:oblique; color:#09b893; font-size:25px">Invest in <span style="color:yellow; font-size:35px">[ YOUR COMMUNITY ]</span> Invests in You</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="light">
                    <p class="text-faded">Here's a helpful video to help you understand why consuming fewer new goods might be a good idea.
                    No time to watch? Our consumerism is hurting the planet, and we only get one. That's why I hope you'll start sharing
                    your unwanted items, reusable resources, and bartering for services within your community.</p>
                    <div style="position:relative;height:0;padding-bottom:56.25%"><iframe src="https://www.youtube.com/embed/3eWBg8ojno4?ecver=2" width="640" height="360" frameborder="0" style="position:absolute;width:100%;height:100%;left:0" allowfullscreen></iframe></div>
                    <br>
    ...
    <section id="about" style="padding:25px">
        <div class="container">
            <div class="row">
